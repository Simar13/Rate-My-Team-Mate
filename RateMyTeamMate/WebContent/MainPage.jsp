...
<body>
<form id="form1" name="form1" method="get" action="/RateMyTeamMate/ViewRating" >
...
<tr> <td height="500" align="center" valign="middle" bgcolor="#DFE2DB" class="Search"><table width="607" height="148" border="0">
      ...
      <tr>
        <td width="601" align="center" class="style5">Find the person to view his/her compatibility with you</td>
      </tr>
      
      <tr>
        <td align="center"><input  placeholder="Enter name..." type="text" name="search" id="search" class="search SearchAzax" align="middle" size="70" class="SearchAzax" class="rcorners13" /></td>
      </tr>
      <tr>
       
      <td align="center"><label>
        <input name="searchbutton" type="submit"  class="bcolour"  id="searchbutton"  value="Search" onmouseover="this.style.color = 'white'" onmouseout="this.style.color = '#3b3a36'"/>
      </label>
     </td>
        ...
        <td height="101" align="center"><table width="407" height="83" border="0">
            ...
            <td align="center"><div class="col-md-4 col-sm-8">
                            <div class="service-item">
                               ...
                               <button type="button" class="btn btn-success" onclick="window.location = '/RateMyTeamMate/Login?action=add'" >ADD A<br />
                GROUP MATE</button>
                            </div>
                        </div></td>
             <td align="center"> 
             <div class="col-md-4 col-sm-8">
               ...
               <button type="button" class="btn btn-success" onclick="window.location = '/RateMyTeamMate/Login?action=rate'" >RATE A <br />
                GROUP MATE</button></div>
                        </div></td>
            </tr>
